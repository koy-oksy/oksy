    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-5 text-md-right">
          <a href="tel:+38 (093) 651-80-05" class="btn btn-primary btn-white">Замовити консультацію</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
          <div class="testimonial-2">
            <blockquote class="mb-4">
              <p>Обираємо дизайн. Вивчення сучасних тенденцій дизайну може допомогти вам визначитися з вибором.</p>
            </blockquote>
          </div>
        </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="testimonial-2">
            <blockquote class="mb-4">
              <p>Розробка сайту, на цьому етапі прошу повністю довіритись мені.</p>
            </blockquote>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
